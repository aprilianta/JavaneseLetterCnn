...
def main(label_file, tfrecords_dir, model_output_dir, num_train_epochs):
    ...
    # Reshape jadi 2 dimensi, lakukan konvolusi
    x_image = tf.reshape(x, [-1, IMAGE_WIDTH, IMAGE_HEIGHT, 1])

    # Convolutional layer pertama. 32 feature maps.
    ...
    # Convolutional layer kedua. 64 feature maps.
    ...
    # Convolutional layer ketiga. 128 feature maps.
    ...
    # Dropout layer. Melawan overfitting
