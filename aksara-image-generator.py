...
def generate_aksara_images(label_file, fonts_dir, output_dir):
    """Generate aksara image files.
...
if __name__ == '__main__':
    ...
    generate_aksara_images(args.label_file, args.fonts_dir, args.output_dir)
