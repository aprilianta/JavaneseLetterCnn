...
def classify(args):
    ...
    # Get relevant nodes.
    x = graph.get_tensor_by_name('aksara-model/input:0')
    y = graph.get_tensor_by_name('aksara-model/output:0')
    keep_prob = graph.get_tensor_by_name('aksara-model/keep_prob:0')
